...
public class ResultUtil {
	 ...
	 * 创建成功响应信息(json)
	 */
	public static ResultInfo createSuccessJSON(String fileName, int messageCode, Object[] objs, Map<String, Object> sysdate) {
		String message = null;
		if(fileName!=null){
			if (objs == null) {
				message = ResourcesUtil.getValue(fileName, messageCode + "");
		...
		return new ResultInfo(ResultInfo.TYPE_RESULT_SUCCESS, messageCode, message, sysdate);
	}
